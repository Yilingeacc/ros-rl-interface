...
(cl:defmethod cl:initialize-instance :after ((m <Goal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Goal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rl_msgs-msg:<Goal> is deprecated: use rl_msgs-msg:Goal instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Goal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rl_msgs-msg:x-val is deprecated.  Use rl_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Goal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rl_msgs-msg:y-val is deprecated.  Use rl_msgs-msg:y instead.")
  (y m))
